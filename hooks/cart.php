...
<?php
    ...
    function seomidia_woocommerce_cart_totals() {
		wc_get_template( '../../woocommerce-plugin/templates/woocommerce/cart/cart-totals.php' );
	}
	...
	function checkout_form_billing() {
		wc_get_template( '../../woocommerce-plugin/templates/woocommerce/checkout/form-billing.php', array( 'checkout' => $this->Checkout ) );
	}
